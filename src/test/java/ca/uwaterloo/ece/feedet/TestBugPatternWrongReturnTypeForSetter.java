...
import ca.uwaterloo.ece.feedet.bugpatterns.declined.WrongReturnTypeForSetter;
 ...
 */
public class TestBugPatternWrongReturnTypeForSetter {
    ...
    @Test public void testSomeLibraryMethod() {
    	...
    	// TP hbase-client/src/main/java/org/apache/hadoop/hbase/client/Scan.java	22d93bd3c6e92d163e253fb9c0c648d17a969f57
    	String projectName = "hbase";
    	String gitURI = projectPathRoot1 + File.separator + projectName;
    	String path = "hbase-client/src/main/java/org/apache/hadoop/hbase/client/Scan.java";
    	String shaId = "22d93bd3c6e92d163e253fb9c0c648d17a969f57~1";
	...
	private void detect(String prjName, String gitURI, String path, String shaId,HashSet<DetectionRecord> identifiedPotentialBug) {
		try {
			...
			process(prjName,new WrongReturnTypeForSetter(prjName,preFixWholeCodeAST,shaId,path,repo).detect());
