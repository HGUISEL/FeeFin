...
import ca.uwaterloo.ece.feedet.bugpatterns.LoadKnownNullByMistake;
 ...
 */
public class TestBugPatternLoadKnownNullByMistake {
    ...
    @Test public void testSomeLibraryMethod() {
    	...
    	// TP src/java/org/apache/hadoop/hbase/regionserver/HRegion.java	65a2c85f2a234f3b2f61bc76d44c6e3666d78f60
    	String projectName = "hbase";
    	String gitURI = projectPathRoot1 + File.separator + projectName;
    	String path = "src/java/org/apache/hadoop/hbase/regionserver/HRegion.java";
    	String shaId = "65a2c85f2a234f3b2f61bc76d44c6e3666d78f60~1";
	...
	private void detect(String prjName, String gitURI, String path, String shaId,HashSet<DetectionRecord> identifiedPotentialBug) {
		try {
			...
			process(prjName,new LoadKnownNullByMistake(prjName,preFixWholeCodeAST,shaId,path,repo).detect());
