 ...
 */
public class TestBugPatternWrongPositionOfNullChecker {
    ...
    @Test public void testSomeLibraryMethod() {
    	...
    	// TP hbase src/java/org/apache/hadoop/hbase/thrift/ThriftUtilities.java	bf9a5aeb190910be8d4ce0aeaa3e8dad3c481678
    	String projectName = "hbase";
    	String gitURI = projectPathRoot1 + File.separator + projectName;
    	String path = "src/java/org/apache/hadoop/hbase/thrift/ThriftUtilities.java";
    	String shaId = "bf9a5aeb190910be8d4ce0aeaa3e8dad3c481678~1";
	...
	private void detect(String prjName, String gitURI, String path, String shaId,HashSet<DetectionRecord> identifiedPotentialBug) {
		try {
			...
			process(prjName,new WrongPositionOfNullChecker(prjName,preFixWholeCodeAST,shaId,path,repo).detect());
